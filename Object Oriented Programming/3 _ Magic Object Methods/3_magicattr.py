...
# Class can define methods that intercept the process anytime an attribute is set or retrieved
...
class Book:
    ...
    # Called when an attribute is retrieved. 
    # Be aware that we can't directly access the attribute name, otherwise a recursive loop is created
    ...
    # Don't set the attribute directly here otherwise a recursive loop causes a crash
    ...
    # We can pretty much generate attributes on the fly with this method
